...
update deceased set SERVICE_NUM = 00 where PERSON_ID = 1;
update deceased set SERVICE_NUM = 02 where PERSON_ID = 3;
update deceased set SERVICE_NUM = 04 where PERSON_ID = 5;
update deceased set SERVICE_NUM = 05 where PERSON_ID = 6;
update deceased set SERVICE_NUM = 06 where PERSON_ID = 7;
update deceased set SERVICE_NUM = 07 where PERSON_ID = 8;
update deceased set SERVICE_NUM = 09 where PERSON_ID = 10;
update deceased set SERVICE_NUM = 10 where PERSON_ID = 11;
update deceased set SERVICE_NUM = 13 where PERSON_ID = 14;
update deceased set SERVICE_NUM = 14 where PERSON_ID = 15;
update deceased set SERVICE_NUM = 15 where PERSON_ID = 16;
update deceased set SERVICE_NUM = 16 where PERSON_ID = 17;
update deceased set SERVICE_NUM = 17 where PERSON_ID = 18;
update deceased set SERVICE_NUM = 19 where PERSON_ID = 20;
update deceased set SERVICE_NUM = 20 where PERSON_ID = 21;
update deceased set SERVICE_NUM = 21 where PERSON_ID = 22;
update deceased set SERVICE_NUM = 23 where PERSON_ID = 24;
update deceased set SERVICE_NUM = 24 where PERSON_ID = 25;
update deceased set SERVICE_NUM = 25 where PERSON_ID = 26;
update deceased set SERVICE_NUM = 26 where PERSON_ID = 27;
update deceased set SERVICE_NUM = 27 where PERSON_ID = 28;
update deceased set SERVICE_NUM = 28 where PERSON_ID = 29;
update deceased set SERVICE_NUM = 29 where PERSON_ID = 30;
